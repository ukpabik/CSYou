...
func main() {
	...
	redis.InitializeRedisClient(fmt.Sprintf("%s:%d", ADDRESS, shared.REDIS_PORT))

	// Initialize ClickHouse Client
	db.InitializeClickHouseClient(ADDRESS, shared.CLICKHOUSE_PORT)
	...
	kafka_io.InitializeReaderAndWriter(ADDRESS, shared.KAFKA_PORT)
